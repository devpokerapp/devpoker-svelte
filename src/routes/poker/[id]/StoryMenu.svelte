...
<div id="story-menu" class="card-body p-0">
	...
	<dialog id="modal-story-options" class="modal modal-bottom sm:modal-middle">
		...
		>
			...
			<li class:disabled={focusingIdx === 0}>
				<button on:click={() => focusing !== undefined && handleMoveUpStory(focusing, focusingIdx)}>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
						fill="currentColor"
			...
			<li class:disabled={focusingIdx === $stories.length - 1}>
				<button
					on:click={() => focusing !== undefined && handleMoveDownStory(focusing, focusingIdx)}
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
